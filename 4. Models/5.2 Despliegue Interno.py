## Para el despliegue interno lo que se propone en este caso, debido a que los clientes son dinámicos (entran nuevos y salen otros), es que el modelo encontrado en el archivo user.py
## se reentrene cada cierto tiempo, esto sería con el fin de que el modelo se presente ajustado de forma constante y garantizar que las predicciones y recomendaciones que entreguemos
## a los usuarios van a ser de la mejor manera posible
